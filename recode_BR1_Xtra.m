...
save([singleSUB_result_folder '/' sub_name '_ProbeX1_results_table.mat'],'ProbeX_results_table')
...
title(['X1 value ProbeX1 for subject:  ' sub_name] )
...
savefig([singleSUB_result_folder '/' sub_name '_probeX1' ])
saveas(figfig,[singleSUB_result_folder '/' sub_name '_probeX1.jpg'])
