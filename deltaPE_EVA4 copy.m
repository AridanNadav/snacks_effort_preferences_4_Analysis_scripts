...
pairtype2val_comp
finalT=[allsubTable(:,{'subjectID','Outcome','itemL','itemR'}) valcomp];
...
for subjectIndex = 1:forloop
    sub_name=['sub_' num2str(subjects(subjectIndex))];
    for k=1:162
        if finalT{(((subjectIndex-1)*162)+k),'itemL'}>finalT{(((subjectIndex-1)*162)+k),'itemR'}
            PEs((((subjectIndex-1)*162)+k),1)=subsPE.(sub_name).vas_1{finalT{(((subjectIndex-1)*162)+k),'itemL'},3}-subsPE.(sub_name).vas_1{finalT{(((subjectIndex-1)*162)+k),'itemR'},3};
            PEs((((subjectIndex-1)*162)+k),2)=subsPE.(sub_name).vas_2{finalT{(((subjectIndex-1)*162)+k),'itemL'},3}-subsPE.(sub_name).vas_2{finalT{(((subjectIndex-1)*162)+k),'itemR'},3};
            PEs((((subjectIndex-1)*162)+k),3)=subsPE.(sub_name).vas_3{finalT{(((subjectIndex-1)*162)+k),'itemL'},3}-subsPE.(sub_name).vas_3{finalT{(((subjectIndex-1)*162)+k),'itemR'},3};
        else
            PEs((((subjectIndex-1)*162)+k),1)=subsPE.(sub_name).vas_1{finalT{(((subjectIndex-1)*162)+k),'itemR'},3}-subsPE.(sub_name).vas_1{finalT{(((subjectIndex-1)*162)+k),'itemL'},3};
            PEs((((subjectIndex-1)*162)+k),2)=subsPE.(sub_name).vas_2{finalT{(((subjectIndex-1)*162)+k),'itemR'},3}-subsPE.(sub_name).vas_2{finalT{(((subjectIndex-1)*162)+k),'itemL'},3};
            PEs((((subjectIndex-1)*162)+k),3)=subsPE.(sub_name).vas_3{finalT{(((subjectIndex-1)*162)+k),'itemR'},3}-subsPE.(sub_name).vas_3{finalT{(((subjectIndex-1)*162)+k),'itemL'},3};
        end
    end
end

PEallsubTable=array2table(PEs,'VariableNames',{'D_vas1','D_vas2','D_vas3'});
finalT2=[finalT PEallsubTable];
writetable(finalT2,[pwd '/finalT3.csv'])
